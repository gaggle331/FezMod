...
public class FurnaceBlock extends BlockContainer{
	...
	public IBlockState getStateFromMeta(int meta)
	{
		return getDefaultState()
						...
						.withProperty(BURNING_SIDES_COUNT, Integer.valueOf(meta));
	}

	@Override
	public int getMetaFromState(IBlockState state)
	{
		return state.getValue(FACING).getIndex() + (state.getValue(BURNING_SIDES_COUNT).intValue());
	}
    ...
    protected BlockState createBlockState() {
        return new BlockState(this, FACING, BURNING_SIDES_COUNT);
    }
