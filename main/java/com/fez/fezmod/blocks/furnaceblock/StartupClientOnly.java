...
public class StartupClientOnly
{
	...
	public static void initClientOnly()
	{
		...
		Item itemFurnaceBlock = GameRegistry.findItem("fezmod", "furnaceblock");
		ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("fezmod:furnaceblock", "inventory");
		final int DEFAULT_ITEM_SUBTYPE = 0;
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(itemFurnaceBlock, DEFAULT_ITEM_SUBTYPE, itemModelResourceLocation);
	}
