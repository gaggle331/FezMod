...
public class GuiInventoryPulver extends GuiContainer{
	// This is the resource location for the background image for the GUI
		private static final ResourceLocation texture = new ResourceLocation("fezmod", "textures/gui/pulverblock_bg.png");
		private TileEntityPulverBlock tileEntity;

		public GuiInventoryPulver(InventoryPlayer invPlayer, TileEntityPulverBlock tileEntityPulverBlock) {
			super(new ContainerPulver(invPlayer, tileEntityPulverBlock));

			// Set the width and height of the gui
			xSize = 176;
			ySize = 207;

			this.tileEntity = tileEntityPulverBlock;
		}
