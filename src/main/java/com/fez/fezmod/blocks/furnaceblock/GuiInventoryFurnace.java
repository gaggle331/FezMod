...
public class GuiInventoryFurnace extends GuiContainer{
	// This is the resource location for the background image for the GUI
		private static final ResourceLocation texture = new ResourceLocation("fezmod", "textures/gui/furnaceblock_bg.png");
		private TileEntityFurnaceBlock tileEntity;

		public GuiInventoryFurnace(InventoryPlayer invPlayer, TileEntityFurnaceBlock tileEntityFurnaceBlock) {
			super(new ContainerFurnace(invPlayer, tileEntityFurnaceBlock));

			// Set the width and height of the gui
			xSize = 176;
			ySize = 207;

			this.tileEntity = tileEntityFurnaceBlock;
		}
